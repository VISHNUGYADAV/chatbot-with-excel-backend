...
def send():
	...
	elif (user == "what do you sell" or user == "what kinds of items are there" or user == "do you have something to build my muscle mass"):
		txt.insert(END, "\n" + "Bot -> We have workout plans and supplements")
